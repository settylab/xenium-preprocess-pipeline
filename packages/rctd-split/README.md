...
`spacexr` and `SPLIT` install from GitHub, not the module or CRAN — see
[`docs/install.md`](docs/install.md) § R side. No GitHub credentials
required (both repos are public), but see that doc for GitHub's
anonymous rate-limit caveat.
